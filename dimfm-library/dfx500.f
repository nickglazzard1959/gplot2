...
C    NOTE RELEVANCE OF COMMENTS IN ELLIPSE ROUTINES.
    4 CONTINUE
      ...
      GO TO 1
    5 CONTINUE
      TA1 = THETA1*ANGCON(1,ANGRP(3))
C NG: THE MAX BELOW IS TO GET AROUND A PROBLEM ON NOS/VE.
C     MAYBE IT SHOULD BE CONDITIONALLY COMPILED.
      DEG = AMOD(MAX(1.0E-32,TA1),360.0)
      DEGS = THETA2 - THETA1
