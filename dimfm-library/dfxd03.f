      SUBROUTINE DFXD03(IF,XARG,YARG,ZARG,NARG)
C --- -----------------------------------------------------------------
C
C --- DFDXD03: VECTOR OUTPUT DRIVER FOR GTERM OUTPUT.
C
...
C
      ...
      PARAMETER( XDCMAX=9999.0, YDCMAX=7499.0, XDCORG=0, YDCORG=0 )
C
...
C     DFX..F USED TO HANDLE RASTER OUTPUT FOR DEVICE
      CALL DFX03F(XARG,YARG,ZARG,NARG,IPAR(1),IPAR(2),DEVLUT,MAXLUT,
     1     LCOL,BLANK,WSBL)
