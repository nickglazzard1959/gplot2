...
C    FLAG AS NOT RUN-LENGTH
   ...
   10 IF (ICHECK.GT.0) WRITE(ERRREC,11) DX
      CALL DFX130(0)
   11 FORMAT(1H0,'**DIMFILM WARNING** CETSC REFERENCED WITH INVALID ARRA
     1Y DIMENSION ',I6/1H0,21X,'CALL IGNORED')
      GO TO 99
   12 IF (RASTLN.GT.(RASTDY+1)) GO TO 99
      IF(ICHECK.GT.0) WRITE(ERRREC,13)
      CALL DFX130(0)
   13 FORMAT(1H0,'**DIMFILM WARNING** CETSC DETECTED SCAN LINE BEYOND CE
