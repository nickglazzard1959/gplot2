...
C
C N.B. UNLIKE SOME DEVICES, EPS "DEVICES" HAVE VARIABLE SIZES.
...
C     PROBABLY IZ.
      SAVE
C
      DATA XDCMAX/5.0/, YDCMAX/5.0/, XDCORG/0.5/, YDCORG/0.5/
      DATA FMWLST/-1.0/
...
C
 1001 CONTINUE
      CALL PSBEGN
C NG- FETCH THE DEVICE DIMENSIONS AND OFFSETS NOW.
C     THIS PROBABLY ONLY NEEDS TO BE DONE ON DEVICE OPEN.
C     BUT AFTER PSBEGN IF DEFAULTS ARE TO BE USED.
      CALL EPSDGT(XDCMAX, YDCMAX, XDCORG, YDCORG)
C
