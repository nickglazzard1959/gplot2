...
C---- NOTE: I DO NOT UNDERSTAND WHAT BROWSERS DO WITH THIS INFORMATION.
...
C            WRITE(CFMT,29)IWIDTH
C 29         FORMAT(' ^W^I^D^T^H="',I4,'"')
            WRITE(CFMT,29)INT(DVXMAX+1)
 29         FORMAT(' ^W^I^D^T^H="',I5,'"')
            CALL SQSPACE(CFMT,ALINE,LUN)
C            WRITE(CFMT,39)IHEIGHT
C 39         FORMAT(' ^H^E^I^G^H^T="',I4,'"')
