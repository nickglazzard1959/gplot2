      PROGRAM FTUTLT(INPUT,TAPE5=INPUT,OUTPUT,TAPE6=OUTPUT)
C
...
C
C TRY DYNAMIC MEMORY ALLOCATION.
C
      DIMENSION DYNAR(1)
      ILEN = 1000
...
C101  FORMAT('+PROMPT>')
 ...
 103  FORMAT(1X,'ICMD=',I4)
      ...
      IF( ICMD .EQ. 0 )THEN
         WRITE(6,104)
 104     FORMAT(1X,'UNKNOWN. TRYING INTEGER')
